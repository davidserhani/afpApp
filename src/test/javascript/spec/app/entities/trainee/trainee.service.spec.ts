...
import { ITrainee, Trainee } from 'app/shared/model/trainee.model';
...
describe('Service Tests', () => {
    describe('Trainee Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TraineeService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Trainee(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Trainee', async () => {
                const returnedFromService = Object.assign(
                    {
                        lastName: 'BBBBBB',
                        firstName: 'BBBBBB'
