...
import cdi.afpa.api.config.audit.AuditEventConverter;
import cdi.afpa.api.domain.PersistentAuditEvent;
...
import static cdi.afpa.api.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
